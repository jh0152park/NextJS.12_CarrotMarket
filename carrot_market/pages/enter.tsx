        ...
        <div className="px-4 mt-16">
            ...
            <div className="mt-8">
                <div className="flex flex-col items-center">
                    ...
                    <div className="grid w-full grid-cols-2 gap-16 mt-8 border-b-2">
                        <button
                            className={cls(
                ...
                <form className="flex flex-col mt-8">
                    <label className="text-sm font-medium text-gary-700">
                    ...
                    <button className="px-4 py-2 mt-5 text-sm font-medium text-white bg-orange-500 border border-transparent rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 hover:bg-orange-600">
                ...
                <div className="mt-8">
                    <div className="relative">
                        <div className="absolute flex w-full border-t border-gray-300" />
